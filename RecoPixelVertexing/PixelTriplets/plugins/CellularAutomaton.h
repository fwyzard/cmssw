...
public:
    ...
    void create_and_connect_cells(std::array<const HitDoublets*, theNumberOfLayers-1> const&, const SeedingLayerSetsHits::SeedingLayerSet&, const TrackingRegion&, const float, const float);
    void evolve();
