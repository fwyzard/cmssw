...
public:
  ...
  void setGBRForest(const GBRForest* LCorrForestEB,
  ...
  void setnPU(int nVtx) { nVtx_ = nVtx; }
  void setPhotonPrimaryVtx(const reco::Vertex& primary) { primaryVertex_ = &primary; }
  ...
  bool isPhotonValidCandidate(const reco::PFBlockRef& blockRef,
    ...
    match_ind.clear();
    RunPFPhoton(blockRef, active, pfPhotonCandidates, pfPhotonExtraCandidates, tempElectronCandidates);
    int ind = 0;
    ...
    for (std::vector<reco::PFCandidate>::const_iterator ec = permElectronCandidates_.begin();
...
private:
  ...
  float CrysPhi_, CrysEta_, VtxZ_, ClusPhi_, ClusEta_, ClusR9_, Clus5x5ratio_, PFCrysEtaCrack_, logPFClusE_, e3x3_;
  ...
  float PFPhoEta_, PFPhoPhi_, PFPhoR9_, PFPhoR9Corr_, SCPhiWidth_, SCEtaWidth_, PFPhoEt_, RConv_, PFPhoEtCorr_, PFPhoE_,
      PFPhoECorr_, MustE_, E3x3_;
