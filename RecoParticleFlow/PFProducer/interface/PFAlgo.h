...
public:
  ...
  //		     );
  void setPFPhotonRegWeights(const GBRForest* LCorrForestEB,
  ...
  const std::unique_ptr<reco::PFCandidateCollection>& pfCandidates() const { return pfCandidates_; }

  /// \return the unfiltered electron collection
  std::unique_ptr<reco::PFCandidateCollection> transferElectronCandidates() { return std::move(pfElectronCandidates_); }
  ...
  std::unique_ptr<reco::PFCandidateCollection> transferCleanedCandidates() { return std::move(pfCleanedCandidates_); }

  /// \return the collection of candidates
  reco::PFCandidateCollection transferCandidates() { return connector_.connect(*pfCandidates_); }

  /// return the pointer to the calibration function
  std::shared_ptr<PFEnergyCalibration> thePFEnergyCalibration() { return calibration_; }
