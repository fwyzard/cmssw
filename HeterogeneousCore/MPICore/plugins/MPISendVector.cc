...
// Class:      MPISendVector
//
/**\class MPISendVector MPISendVector.cc HeterogeneousCore/MPICore/plugins/MPISendVector.cc
...
// class declaration
//
class MPISendVector : public edm::stream::EDProducer<> {
public:
  explicit MPISendVector(const edm::ParameterSet&);
  ~MPISendVector() override;
...
//
MPISendVector::MPISendVector(const edm::ParameterSet& iConfig)
...
void MPISendVector::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
  using namespace edm;
  ...
  */
  ...
  MPI_Send(&vectorData[0], vectorData.size(), MPI_INT, 0, tagID, dataComm_);
}

// ------------ method called once each stream before processing any runs, lumis or events  ------------
void MPISendVector::beginStream(edm::StreamID stream) {
  sid_ = stream;
  // please remove this method if not needed
}

// ------------ method called once each stream after processing all runs, lumis and events  ------------
void MPISendVector::endStream() {
  // please remove this method if not needed
}
...
/*
void
MPISendVector::beginRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void
MPISendVector::endRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void
MPISendVector::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
/*
void
MPISendVector::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void MPISendVector::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(MPISendVector);
