#ifndef DataFormats_XyzId_interface_XyzIdSoA_hand_defined_h
#define DataFormats_XyzId_interface_XyzIdSoA_hand_defined_h
...
class XyzIdSoA {
public:
  static constexpr cms_int32_t alignment = 128;  // align all fields to 128 bytes
  ...
  static constexpr uint32_t pad(cms_int32_t size) { return ((size + alignment - 1) / alignment * alignment); }
...
#endif  // DataFormats_XyzId_interface_XyzIdSoA_hand_defined_h
